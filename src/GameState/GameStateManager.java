...
public class GameStateManager {
	...
	private int[][] attributes = { { 6, 4, 2 }, { 2, 6, 4 }, { 2, 4, 6 } };

	private String[] platformerMaps = { "/Maps/course_1.txt", "/Maps/course_2.txt", "/Maps/course_3.txt",
			"/Maps/course_4.txt", "/Maps/course_5.txt", "/Maps/course_8.txt", "/Maps/course_9.txt",
			"/Maps/course_10.txt" };

	private String[] tilesets = { "/Tilesets/falltileset.gif", "/Tilesets/falltileset.gif", "/Tilesets/falltileset.gif",
			"/Tilesets/wintertileset.gif", "/Tilesets/wintertileset.gif", "/Tilesets/falltileset.gif",
			"/Tilesets/falltileset.gif", "/Tilesets/wintertileset.gif" };

	private String[] backgrounds = { "/Backgrounds/bluebg.gif", "/Backgrounds/bluebg.gif", "/Backgrounds/blackbg.gif",
			"/Backgrounds/bluebg.gif", "/Backgrounds/blackbg.gif", "/Backgrounds/blackbg.gif",
			"/Backgrounds/bluebg.gif", "/Backgrounds/blackbg.gif" };
	...
	public void loadState(int state) {
		...
		if (state == PLATFORMERSTATE1)
			gameStates[state] = new PlatformerState1(this, character, getPlatformerCourse(), attributes);
		currentState = state;
		if (state == TRANSITIONSTATE1)
			gameStates[state] = new TransitionState1(this, character, getPlatformerCourse());
		if (state == FINALSTATE1)
			gameStates[state] = new FinalState1(this, character, getFinalCourse());
